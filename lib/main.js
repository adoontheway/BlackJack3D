...
function create(){
    ...
    dealerBoard = game.add.text(game.world.centerX - 180, 120, "DEALER:0", style);
    myBoard = game.add.text(game.world.centerX - 180, game.world.height-200, "PLAYER:0", style);
...
Player.prototype.addCard = function(card){
	...
	if( !poker){
		poker = game.add.image(this.cardStartX+30*this.cards.length, this.cardY,''+card);
	}
