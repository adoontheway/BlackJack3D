	...
	public class MyBetUI extends View {
		...
		protected static var uiXML:XML =
			<View width="106" height="41">
			  ...
			  <Label text="100.00" x="8" y="5" width="39" height="29" color="0xffffff" size="20" var="lab" align="left" font="Din" bold="false" autoSize="left"/>
			  <Button skin="png.images.btn_close" x="27" y="-3" stateNum="1" var="btn_close"/>
			</View>;
